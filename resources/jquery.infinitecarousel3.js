...
//				app.u.dump('infiniteCarousel3 Started');
				...
				if(o.showControls)
				{
					...
					//w/ out the quickview onclick, these buttons will work (they must be un-hidden w/ css)
					//removing them caused undesired behavior with the carousel which could likely be fixed later if neccessary
					$('.ic_controls',obj).on('click', function(){
						...
						else {pause();} //else was added to allow for pausing while carousel was running.
					});
				}
