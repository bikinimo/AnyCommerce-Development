...
/*bmo*/			'limitedTimeOffersTemplate',
/*bmo*/			'productListTemplatePopout',
...
/*bmo*/						var SSLlocation = zGlobals.appSettings.https_app_url+"?loadDirectly=true&cartID="+app.vars.cartID+"&_session="+app.vars._session+"#checkout?show=checkout";
							_gaq.push(['_link', SSLlocation]); //for cross domain tracking.
...
/*bmo*/				var pageTemplates = new Array('productListTemplatePopout','categoryTemplate','productTemplate','companyTemplate','customerTemplate','homepageTemplate','searchTemplate','cartTemplate','checkoutTemplate','pageNotFoundTemplate');
